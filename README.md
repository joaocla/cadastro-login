...
Para acessar a página de login do projeto, clique [aqui](https://joaocla.github.io/cadastro-login/pages/login.html){:target="_blank"}, ou para acessar a pagina de cadastro, cliquei [aqui](https://joaocla.github.io/cadastro-login/pages/cadastro.html){:target="_blank"}.
